...
public class BookingPresenter implements ViewObserver{
    ...
    public void onChangeReservationTable(int idReservation, int tableNoOld, Date reservationDate, int tableNo, String name) {
        model.deleteReservation(idReservation, tableNoOld);
