...
public class BookingView implements View {
     ...
     * @param name
     */
    public void changeReservationTable(int idReservation, int tableNoOld, Date reservationDate, int tableNo, String name){
        observer.onChangeReservationTable(idReservation, tableNoOld, reservationDate, tableNo, name);
    }
